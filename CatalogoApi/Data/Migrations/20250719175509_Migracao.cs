    ...
    public partial class Migracao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistFilme", x => new { x.FilmesId, x.PlaylistsId });
                    table.ForeignKey(
                        name: "FK_PlaylistFilme_Filmes_FilmesId",
                        column: x => x.FilmesId,
                        principalTable: "Filmes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaylistFilme_Playlists_PlaylistsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistLivro", x => new { x.LivrosId, x.PlaylistsId });
                    table.ForeignKey(
                        name: "FK_PlaylistLivro_Livros_LivrosId",
                        column: x => x.LivrosId,
                        principalTable: "Livros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaylistLivro_Playlists_PlaylistsId",
                        column: x => x.PlaylistsId,
                        principalTable: "Playlists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistFilme_PlaylistsId",
                table: "PlaylistFilme",
                column: "PlaylistsId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistLivro_PlaylistsId",
                table: "PlaylistLivro",
                column: "PlaylistsId");
